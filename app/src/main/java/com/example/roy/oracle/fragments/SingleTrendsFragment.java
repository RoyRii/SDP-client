...
public class SingleTrendsFragment extends Fragment implements FragmentVisibility {
    ...
    public SingleTrendsFragment() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public SingleTrendsFragment(int request) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_single_trends, container, false);
        ...
        Connection apiCall = new Connection(formBuilder, URL + "/trends", new MessageParse() {
            ...
            public void parseResponse(String response) {
                ...
                try {
                    ...
                    SingleTrendsAdapter adapter = new SingleTrendsAdapter(getActivity(), getContext(), trends_list);
