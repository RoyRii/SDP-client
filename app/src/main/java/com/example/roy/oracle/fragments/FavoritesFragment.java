...
import com.example.roy.oracle.Adapters.FavoriteAdapter;
...
public class FavoritesFragment extends Fragment implements FragmentVisibility {
   ...
   @Override
    public void fragmentBecameVisible() {
        ...
        Connection apiCall = new Connection(formBuilder, URL + "/likes", new MessageParse() {
            @Override
            public void parseResponse(String response) {
                ...
                try {
                    ...
                    FavoriteAdapter adapter = new FavoriteAdapter(getActivity(), getContext(), retweets, urls, numbers, users);
