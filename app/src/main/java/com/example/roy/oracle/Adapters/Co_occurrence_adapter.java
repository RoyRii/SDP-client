...
public class Co_occurrence_adapter extends BaseAdapter {
    private List<Trend> trends;
    private Activity activity;
    private Context context;

    public Co_occurrence_adapter(Activity activity, Context context, List<Trend> trends) {
        this.trends = trends;
    ...
    public View getView(final int i, final View view, ViewGroup viewGroup) {
        ...
        ListView list = activity.findViewById(R.id.list2);
        ...
        sentiment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ChartFragment chart = new ChartFragment("occur", i);
